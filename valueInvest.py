        ...
        rv_dataframe = rv_dataframe.append(
            pd.Series(
                [
                    ...
                    data[symbol]['advanced-stats']['marketcap']/1000000000,
                    'N/A',
...
column_formats = {
                   ...
                   # 'C': ['Sector', string_template],
                    ...
                    'D': ['Market Cap (bil)', dollar_template],
                    'E': ['Num. Shares to Buy', integer_template],
                    'F': ['P/E Ratio', float_template],
                    'G': ['P/E Percentile', percent_template],
                    'H': ['Forward P/E Ratio', float_template],
                    'I': ['Forward P/E Percentile', percent_template],
                    'J': ['P/B Ratio', float_template],
                    'K': ['P/B Percentile', percent_template],
                    'L': ['P/S Ratio', float_template],
                    'M': ['P/S Percentile', percent_template],
                    'N': ['Debt/Equity Ratio', float_template],
                    'O': ['D/E Percentile', percent_template],
                    'P': ['PEG', float_template],
                    'Q': ['PEG Percentile', percent_template],
                    'R': ['EV/EBITDA', float_template],
                    'S': ['EV/EBITDA Percentile', percent_template],
                    'T': ['EV/GP', float_template],
                    'U': ['EV/GP Percentile', percent_template],
                    'V': ['Put/Call Ratio', float_template],
                    'W': ['Put/Call Percentile', percent_template],
                    'X': ['RV Score', percent_template]
                  }
